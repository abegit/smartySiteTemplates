...
<li><a href="pages.php?id=drsuzytv2" {if $item=='listen' } class="hilite" {/if} ><i class="bono-microphone"></i>Live</a></li>
...
{include file="search/search_box2.tpl" position=$searchpos}
