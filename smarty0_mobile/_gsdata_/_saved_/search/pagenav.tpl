{**
* The search page navigation 
*
*}

{assign var="onpage" value=$root.page.info.page[0]}
{assign var="pcount" value=$root.page.numpages.p|@count}
...
<tr>
	...
	{if $onpage != 1}
		...
		<a href="{include file="$spath/general/pg_search.tpl" page=$onpage-1}">
