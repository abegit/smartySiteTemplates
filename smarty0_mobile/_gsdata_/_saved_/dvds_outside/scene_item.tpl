...
<a class="title" href="{$root.page.tour.JoinUrl}" >{$item.Title[0]}</a>
{elseif isset($hType) && $hType }<a class="title" href="{$root.page.tour.JoinUrl}" >{$item.Title[0]}</a>
{elseif isset($vType) && $vType }<a class="title" href="{$root.page.tour.JoinUrl}" >{$item.Title[0]}</a>
{else}<a class="title" href="{$root.page.tour.JoinUrl}" >{$item.Title[0]}</a>
{/if}
