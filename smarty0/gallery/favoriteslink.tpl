...
{if isset($isFav)}
	...
	<td>
<a class="favorites_link" href="favorites.php?del={$root.page.contentgroup.Id[0]}&amp;type={$root.page.settype[0]}&amp;ret=1">
{$templateconf.txtremovefromfavorites}</a>
</td>
{else}
	<td><img src="{$image_folder}/icons/add.gif" width="16" height="16" alt=""/></td>
	<td>
	<a class="favorites_link" href="favorites.php?add={$root.page.contentgroup.Id[0]}&amp;type={$root.page.settype[0]}">
