...
<div style="padding-left:25px;"><img src="images/commentarrow.gif"></div>
<div class="comments_box">
...
<input type="hidden" name="contenttype" value="set" />
<input type="hidden" name="itemid" value="{$root.page.contentgroup.Id[0]}" />
<input type="hidden" name="redirect" value="{include file="$spath/general/pg_gallery.tpl" type=$root.page.settype[0] id=$root.page.contentgroup.Id[0] page=$root.page.onpage[0] seoname=$root.page.contentgroup.SEOname[0] item=$root.page.contentgroup}"/>
