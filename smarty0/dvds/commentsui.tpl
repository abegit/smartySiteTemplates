...
<input type="hidden" name="contenttype" value="dvd" />
<input type="hidden" name="itemid" value="{$root.page.dvd[0].Id[0]}" />
<input type="hidden" name="redirect" value="{include file="$spath/general/pg_dvds.tpl" id=$root.page.dvd[0].Id[0] item=$root.page.dvd[0]}"/>
