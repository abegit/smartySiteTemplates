...
{if $root.page.pages_attr[0].onpage != 1}
 ...
 <a class="pagenav prv" href="{include file="$spath/general/pg_category.tpl" id=$root.page.category.Id[0] page=$ppage s=$root.page.sort[0] sw=$root.page.letter[0] seoname=$root.page.category.SEOname[0] item=$root.page.category}">< {$templateconf.txtprevious}</a>
{/if}
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span> 
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 <a class="pagenav nxt" href="{include file="$spath/general/pg_category.tpl" id=$root.page.category.Id[0] page=$npage s=$root.page.sort[0] sw=$root.page.letter[0] seoname=$root.page.category.SEOname[0] item=$root.page.category}">{$templateconf.txtnext} ></a>
{/if}
