...
<input type="hidden" name="contenttype" value="model" />
<input type="hidden" name="itemid" value="{$item.Id[0]}" />

<input type="hidden" name="redirect" value="{include file="$spath/general/pg_sets.tpl" id=$item.Id[0] seoname=$item.SEOname[0] item=$item}"/>
