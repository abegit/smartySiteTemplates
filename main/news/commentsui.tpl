...
<input type="hidden" name="redirect" value="{include file="$spath/general/pg_news.tpl" id=$root.page.content.item[0].Id[0] item=$root.page.content.item[0] tag=$root.page.tag}" />
