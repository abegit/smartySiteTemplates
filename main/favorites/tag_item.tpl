...
<tr>
	...
	<td><a class="favorites_link" href="favorites.php?page=tags&amp;deleteset=1&amp;setid={$item.Id[0]}&amp;id={$root.page.tagId[0]}">{$templateconf.txtdeletetag} "{$tagname}"</a>
	</td>
</tr>
</table>
...
<!--Date Added-->
{if $item.TagAdded[0] != ""}Added as Tag: {$templateconf.txtaddedtotags} {$item.TagAdded[0]}{/if}
</td></tr>
<tr>
