...
{if $root.page.onpage[0] != 1}
 ...
 <a class="pagenav" href="poll.php?page={$ppage}">< {$templateconf.txtprevious}</a>
{/if}
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span> 
...
{else}
<a class="pagenav" href="poll.php?page={$page}">{$page}</a>
{/if}
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 <a class="pagenav" href="poll.php?page={$npage}">{$templateconf.txtnext} ></a>
{/if}
